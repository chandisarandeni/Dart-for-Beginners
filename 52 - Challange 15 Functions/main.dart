void main() {
  // Create a function that determines the shipping cost based on the destination country and the weight of the package.
  ...
  print("The shipping cost is $cost"); // Expected output: The shipping cost is 298.0
}
...
double? calculateShippingCost(String country, double weight) {
  ...
  // Determine the additional cost based on the country
  switch (country) {
    case "Germany":
      additionalCost = 0.0;
      break;
  ...
  // Calculate the shipping cost if the country is in the list
